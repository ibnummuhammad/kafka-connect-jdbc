...
public class BufferedRecords {
  ...
  public List<SinkRecord> add(SinkRecord record) throws SQLException, TableAlterOrCreateException {
    ...
    if (schemaChanged || updateStatementBinder == null) {
      ...
      final String insertSqlNew = "INSERT INTO \"data_warehouse\".\"development_ibnu_muhammad\".\"testing_ibn_kubeflow1\" ( \"params\", \"payload\", \"etl_id\", \"etl_id_ts\", \"etl_id_partition\", \"run_ts\" ) VALUES ( (JSON_PARSE ( ? )), (JSON_PARSE ( ? )), ?, ('2022-10-10 11:30:30+00'), ?, ('2022-10-10 11:30:30+00') )";
